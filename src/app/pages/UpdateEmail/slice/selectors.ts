...
const selectDomain = (state: RootState) => state.updateEmail || initialState;
...
export const selectResendData = createSelector(
  [selectDomain],
  subState => subState.resend.data,
);

export const selectResendLoading = createSelector(
  [selectDomain],
  subState => subState.resend.loading,
);

export const selectResendError = createSelector(
  [selectDomain],
  subState => subState.resend.error,
);

export const selectResendRequest = createSelector(
  [selectDomain],
  subState => subState.resend.request,
);
