      ...
      <Dialog show={showMessage} size="small">
        <div className="text-center" style={{ padding: '40px 20px 30px' }}>
          ...
          <Paragraph align="center" margin="0 0 35px">
            Hi Squidee! Updating your name requires you to send us an email for
            us to evaluate your request. If you wish to proceed, you will
            receive feedback within the next 24-48 hours.
          </Paragraph>
          <Button
            fullWidth
            onClick={() => {
